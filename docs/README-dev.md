# skas-algo-platform — developer and operator notes

> Moved from the repository root on 2026-09-22; the root README is now the public-facing
> overview. This file is the working orientation: setup, architecture seams, how to run.
...
tests/          ~85 test files (engine, strategies, options, live, API, parity)
```
...
- **Options — positional:** Short Premium, Call / Put / Batman Ratio Monthly, HNI Weekly,
  ...
  calendar; the fair-value line picks the side), **Put Condor** (defined-risk monthly debit),
