...
_INTRADAY_REPLAY = ["intraday_straddle", "straddle_btst", "weekly_intraday_straddle", "call_put_ratio_expiry",
                    ...
                    "hni_weekly", "21_ema_momentum", "put_condor", "directional_condor",
